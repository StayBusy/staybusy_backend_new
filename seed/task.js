...
const start = async () => {
  try {
    ...
    const jsonTask = JSON.parse(await readFile(path.join(__dirname, 'tasks.json'), 'utf-8'));
    const jsonTag = JSON.parse(await readFile(path.join(__dirname, 'tags.json'), 'utf-8'));
